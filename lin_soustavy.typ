...
+ $B = mat(lambda,1;0,lambda)$ je-li $lambda_(1,2)$ dvonásobné reálné vlastní číslo,
+ $B = mat(alpha,- beta;beta,alpha)$ je-li $lambda_(1,2)$ sdružené komplexní vlastní číslo.
...
- Je-li $X_0 in E^s$ pak pro $forall t in RR$ je $lim_(t arrow infinity) e^(A t) X_0 = 0$. Bod rovnováhy je asymptoticky stabilní.
- Je-li $X_0 in E^u$ pak pro $forall t in RR$ je $lim_(t arrow infinity) e^(A t) X_0 = plus.minus infinity$. Bod rovnováhy je asymptoticky nestabilní.]
